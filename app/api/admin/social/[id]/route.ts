...
import { updateSocialPost, type PostStatus } from "@/lib/supabase/social"
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const body = (await req.json()) as { scheduled_date?: string | null; status?: PostStatus }

    const patch: { scheduled_date?: string | null; status?: PostStatus } = {}
