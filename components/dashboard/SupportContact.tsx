...
/**
 * Déclencheur cliquable (children) qui ouvre un modal pour écrire un message
 * au support. Réutilisable partout dans le tableau de bord.
 */
  ...
  return (
    <>
      <button
        ...
        className={
          className ??
          "text-gold-700 hover:text-gold-600 transition-colors underline underline-offset-2 font-medium"
        }
      >
        {children}
      </button>
