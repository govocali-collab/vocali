...
export const fr: Dictionary = {
  ...
  franchise: {
    ...
    title: "Conçu pour les entreprises multi-succursales.",
    subtitle:
      "Déployez une expérience client uniforme dans chaque point de vente, sans surcharge opérationnelle.",
    features: [
      {
        title: "Standardisation complète",
        desc: "Le même niveau de service dans chaque succursale, chaque jour, sans variation.",
      },
      {
      ...
      },
      {
        ...
        desc: "Supervisez toutes vos succursales depuis un seul tableau de bord simplifié.",
      },
      {
        title: "Déploiement en 48 heures",
        desc: "Opérationnel rapidement, sans infrastructure complexe à mettre en place.",
      },
    ],
