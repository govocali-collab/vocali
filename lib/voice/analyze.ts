      ...
      tools: [
        {
          ...
          input_schema: {
            ...
            properties: {
              ...
              name: { type: ["string", "null"], description: "Prénom (et nom si donné) de la cliente, sinon null." },
              phone: { type: ["string", "null"], description: "Numéro de rappel donné PENDANT l'appel, chiffres seulement, sinon null." },
              email: { type: ["string", "null"], description: "Courriel si donné, sinon null." },
              service_interest: { type: ["string", "null"], description: "Service ou soin mentionné, sinon null." },
              preferred_date: { type: ["string", "null"], description: "Date souhaitée en texte libre, sinon null." },
              preferred_time: { type: ["string", "null"], description: "Moment souhaité en texte libre, sinon null." },
              notes: { type: ["string", "null"], description: "Message ou détail utile pour la clinique, sinon null." },
